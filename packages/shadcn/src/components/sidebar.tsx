...
import {
  ...
  SheetHeader,
  SheetTitle,
} from '@workspace/shadcn/components/sheet';
import { Skeleton } from '@workspace/shadcn/components/skeleton';
import {
  Tooltip,
  TooltipContent,
  TooltipTrigger,
      ...
      <div
        ...
        className={cn(
          ...
          side === 'left'
            ? `
              left-0
              group-data-[collapsible=offExamples]:left-[calc(var(--sidebar-width)*-1)]
            `
            : `
              right-0
              group-data-[collapsible=offExamples]:right-[calc(var(--sidebar-width)*-1)]
            `,
    ...
    <button
      ...
      className={cn(
        ...
        `
          ...
          group-data-[collapsible=offExamples]:after:left-full
          hover:group-data-[collapsible=offExamples]:bg-sidebar
        `,
