  ...
  `,
  {
    variants: {
      ...
      size: {
        ...
        xs: `
          gap-2 px-2.5 py-2
          [[data-slot=dropdown-menu-content]_&]:p-0
        `,
      },
    },
    defaultVariants: {
...
function ItemTitle({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div
      ...
      className={cn(
        `
          line-clamp-1 flex w-fit items-center gap-2 text-sm leading-snug
...
function ItemDescription({ className, ...props }: React.ComponentProps<'p'>) {
  return (
    <p
      ...
      className={cn(
        `
          line-clamp-2 text-left text-sm leading-normal font-normal
