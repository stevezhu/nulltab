...
function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      ...
      className={cn(
        `
          flex w-fit items-center justify-between gap-1.5 rounded-md border
        ...
        <SelectPrimitive.Popup
          ...
          className={cn(
            `
              ...
              w-(--anchor-width) min-w-36 origin-(--transform-origin)
              overflow-x-hidden overflow-y-auto rounded-md bg-popover
  ...
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        ...
        `,
        // XXX: comment out seemingless pointless class that overwrites styles in children
