        ...
        <MenuPrimitive.Popup
          ...
          className={cn(
            `
              ...
              rounded-md bg-popover p-1 text-popover-foreground shadow-md ring-1
...
function DropdownMenuSubContent({
  ...
  return (
    <DropdownMenuContent
      ...
      className={cn(
        `
          w-auto min-w-[96px] rounded-md bg-popover p-1 text-popover-foreground
...
function DropdownMenuCheckboxItem({
  ...
  return (
    <MenuPrimitive.CheckboxItem
      ...
      className={cn(
        `
          relative flex cursor-default items-center gap-2 rounded-sm py-1.5 pr-8
